...
<script>
    function imprimir(que) {
        ...
        var contenido = "<html><head><link rel='stylesheet' href='public/css/plantilla.css' type='text/css'></head><body onload='window.print();window.close();'>";
        contenido = contenido +'<p align="center" >Sistema de informação para o Processo Eleitoral </p><br>' + document.getElementById(que).innerHTML + "</body></html>";
...
<div class="demo">
    <div id="tabs">
        <ul>
            <li><a href="#tabs-1"><?php echo $label["relatorio_1"] ?></a><a href="javascript:imprimir('tabs-1')"><img src="public/imagenes/print.jpg"></button></a></li>
            <li><a href="#tabs-2"><?php echo $label["relatorio_2"] ?></a><a href="javascript:imprimir('tabs-2')"><img src="public/imagenes/print.jpg"></button></a></li>
            <li><a href="#tabs-3"><?php echo $label["relatorio_3"] ?></a><a href="javascript:imprimir('tabs-3')"><img src="public/imagenes/print.jpg"></button></a></li>
            <li><a href="#tabs-4"><?php echo $label["relatorio_3"] ?></a><a href="javascript:imprimir('tabs-4')"><img src="public/imagenes/print.jpg"></button></a></li>            
        </ul>
        <div id="tabs-1">
        ...
        <div id="tabs-4">
            <?php require 'templates/select-municipio.php'; ?>
        </div>        
