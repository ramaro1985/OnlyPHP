...
echo Utils::getDivTitulo($label["listado_evento_postcampanna"]);

$casoUso = "evento_mpla";

$mySession->where[$casoUso]['where'] = 'id_ubicacion_evento = 3';
$mySession->actualizar();
$mySession->registrarVariable('id_ubicacion_evento', 3);
