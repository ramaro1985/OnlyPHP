...
echo Utils::getDivTitulo($label["listado_evento_precampanna"]);

$casoUso = "evento_mpla";
$template = "lst";

$mySession->where[$casoUso]['where'] = 'id_ubicacion_evento = 1';
$mySession->actualizar();

$mySession->registrarVariable('id_ubicacion_evento', 1);
