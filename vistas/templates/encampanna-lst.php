...
echo Utils::getDivTitulo($label["listado_evento_encampanna"]);

$casoUso = "evento_mpla";
$template = "lst";

$mySession->where[$casoUso]['where'] = 'id_ubicacion_evento = 2';
$mySession->actualizar();
$mySession->registrarVariable('id_ubicacion_evento', 2);
