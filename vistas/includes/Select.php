...
class Zebra_Form_Select extends Zebra_Form_Control
{
    ...
    function add_options($options, $overwrite = false)
    {
        ...
        // if options are not specified as an array
             ...
             //comente este codigo para cuando no tenga elemento alguno las listas no emita error
    ...
    function toHTML()
    {
        ...
        /* comente este codigo para cuando no tenga elemento alguno las listas no me cree el -select-
