 ...
 *  @package    Controls
 */
class Zebra_Form_Submit_1 extends Zebra_Form_Control
{
     ...
     *  @return void
     */
    function Zebra_Form_Submit_1($id, $caption, $attributes = '')
    {
    ...
    function toHTML()
    {
        ...
        return '<input ' . $this->_render_attributes() . ($this->form_properties['doctype'] == 'xhtml' ? '/' : '') . '>'." ".'<input type="button" class="submit" name="cancelar" id="cancelar" value="Cancelar" onClick="javascript:history.back();">';
