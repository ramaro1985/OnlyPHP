...
<table> 
    <tr class="row"> 
        <td valign="top"><?php echo $label_nombre_empresa ?></td> 
        <td valign="top"><?php echo $nombre_empresa ?></td> 
    </tr>
    <tr class="row even"> 
        <td valign="top"><?php echo $label_direcion ?></td> 
        <td valign="top"><?php echo $direccion ?></td> 
    </tr>
    ...
    <tr class="row even"> 
        <td align="right" colspan="2"> 
            <table cellpadding="0" cellspacing="2" width="650" border="0"> 
                <tr> 
                    <td colspan="2"><?php echo $label_proyectos_disponibles ?></td> 
                    <td colspan="2"></td> 
                    <td colspan="2"><?php echo $label_proyectos_incluidos ?></td> 
                </tr> 
                <tr> 
