...
if ((isset($_POST["MM_from"])) && ($_POST["MM_from"] == "guardar_nuevo")) {
    ...
    $Obj = new Producto();
    $str = array($_POST["nombre"], $_POST["cantidad_producto"], $_POST["precio_costo"], $_POST["descripcion"]);
...
if ((isset($_POST["MM_from"])) && ($_POST["MM_from"] == "actualizar")) {
    ...
    $Obj = new Producto();
    $str = array($_POST["descripcion"], $_POST["cantidad_producto"], $_POST["precio_costo"], $_POST["nombre"]);
