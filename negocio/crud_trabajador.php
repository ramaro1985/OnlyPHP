...
if ((isset($_POST["MM_from"])) && ($_POST["MM_from"] == "buscar")) {
    ...
    $url = Utils::construirURLdeARRAY($_POST, $arrGet, 'arrGet', 'MM_from_trabajador');
...
if ((isset($_POST["MM_from_trabajador"])) && ($_POST["MM_from_trabajador"] == "guardar_nuevo_trabajador")) {
    ...
    $Obj = new Trabajador();
    $str = array($_POST["id_cargo"], $mySession->obtenerVariable('id_empresa'), $_POST["nombre_apellido"], $_POST["nro_identidad"], $_POST["correo"], $_POST["telefono"], $_POST["sexo"]);
...
//El caso de uso (usuario) --- accion --- clic en el boton guardar del formulario add (retorna al listado)
if ((isset($_POST["MM_from_trabajador"])) && ($_POST["MM_from_trabajador"] == "actualizar_trabajador")) {
    ...
    if ($Obj->updateRecord($_POST['id'], $str) == FALSE) {
