...
if ((isset($_POST["MM_from"])) && ($_POST["MM_from"] == "buscar")) {
    ...
    $url = Utils::construirURLdeARRAY($_POST, $arrGet, 'arrGet', 'MM_from_eval');
...
if ((isset($_POST["MM_from_eval"])) && ($_POST["MM_from_eval"] == "guardar_nuevo_eval")) {
    ...
    $Obj = new Recorridoevaluacion();
    $str = array($mySession->obtenerVariable('id_recorrido'),$_POST['id_tipo_evaluacion'],$_POST["descripcion"], $_POST["fecha_evaluacion"]);
...
//El caso de uso (usuario) --- accion --- clic en el boton guardar del formulario add (retorna al listado)
if ((isset($_POST["MM_from_eval"])) && ($_POST["MM_from_eval"] == "actualizar_eval")) {
